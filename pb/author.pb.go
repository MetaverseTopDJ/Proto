...
type Author struct {
	...
	Hot             uint64 `protobuf:"varint,8,opt,name=hot,proto3" json:"hot"`
...
func (x *SimpleAuthor) GetHot() uint64 {
	if x != nil {
		return x.Hot
	}
	return 0
...
func (x *CreateAuthorPost) GetHot() uint64 {
	if x != nil {
		return x.Hot
	}
	return 0
...
func (x *UpdateAuthorPost) GetHot() uint64 {
	if x != nil {
		return x.Hot
	}
	return 0
...
type AuthorPaginationResponse struct {
	...
	Message string                            `protobuf:"bytes,1,opt,name=message,proto3" json:"message"`
	Data    *AuthorPaginationResponse_Authors `protobuf:"bytes,2,opt,name=data,proto3" json:"data"`
}
...
func (x *AuthorPaginationResponse) GetData() *AuthorPaginationResponse_Authors {
	if x != nil {
		return x.Data
	}
	return nil
...
type AuthorPaginationResponse_Authors struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	List  []*Author `protobuf:"bytes,1,rep,name=list,proto3" json:"list"`
	Total int64     `protobuf:"varint,2,opt,name=total,proto3" json:"total"`
}

func (x *AuthorPaginationResponse_Authors) Reset() {
	*x = AuthorPaginationResponse_Authors{}
	if protoimpl.UnsafeEnabled {
...
func (x *AuthorPaginationResponse_Authors) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AuthorPaginationResponse_Authors) ProtoMessage() {}

func (x *AuthorPaginationResponse_Authors) ProtoReflect() protoreflect.Message {
	mi := &file_collect_author_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AuthorPaginationResponse_Authors.ProtoReflect.Descriptor instead.
func (*AuthorPaginationResponse_Authors) Descriptor() ([]byte, []int) {
	return file_collect_author_proto_rawDescGZIP(), []int{6, 0}
}

func (x *AuthorPaginationResponse_Authors) GetList() []*Author {
	if x != nil {
		return x.List
	}
	return nil
...
func (x *AuthorPaginationResponse_Authors) GetTotal() int64 {
	if x != nil {
		return x.Total
	}
	return 0
...
var file_collect_author_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x18, 0x08, 0x20, 0x01, 0x28, 0x04, 0x52, 0x03, 0x68, 0x6f, 0x74, 0x12, 0x1a, 0x0a,
	...
	0x6e, 0x65, 0x72, 0x12, 0x10, 0x0a, 0x03, 0x68, 0x6f, 0x74, 0x18, 0x08, 0x20, 0x01, 0x28, 0x04,
	...
	0x28, 0x04, 0x52, 0x03, 0x68, 0x6f, 0x74, 0x12, 0x1a, 0x0a, 0x08, 0x66, 0x61, 0x63, 0x65, 0x62,
	...
	0x10, 0x0a, 0x03, 0x68, 0x6f, 0x74, 0x18, 0x08, 0x20, 0x01, 0x28, 0x04, 0x52, 0x03, 0x68, 0x6f,
	...
	0x64, 0x61, 0x74, 0x61, 0x22, 0x59, 0x0a, 0x12, 0x48, 0x6f, 0x74, 0x41, 0x75, 0x74, 0x68, 0x6f,
	0x72, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x6d, 0x65,
	0x73, 0x73, 0x61, 0x67, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x73,
	0x73, 0x61, 0x67, 0x65, 0x12, 0x29, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x02, 0x20, 0x03,
	0x28, 0x0b, 0x32, 0x15, 0x2e, 0x63, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x2e, 0x53, 0x69, 0x6d,
	0x70, 0x6c, 0x65, 0x41, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22,
	0xb9, 0x01, 0x0a, 0x18, 0x41, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x50, 0x61, 0x67, 0x69, 0x6e, 0x61,
	...
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x29, 0x2e, 0x63, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x2e, 0x41,
	0x75, 0x74, 0x68, 0x6f, 0x72, 0x50, 0x61, 0x67, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x2e, 0x41, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x73, 0x52,
	0x04, 0x64, 0x61, 0x74, 0x61, 0x1a, 0x44, 0x0a, 0x07, 0x41, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x73,
...
var file_collect_author_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_collect_author_proto_goTypes = []interface{}{
	...
	(*HotAuthorsResponse)(nil),               // 5: collect.HotAuthorsResponse
	(*AuthorPaginationResponse)(nil),         // 6: collect.AuthorPaginationResponse
	(*AuthorPaginationResponse_Authors)(nil), // 7: collect.AuthorPaginationResponse.Authors
}
var file_collect_author_proto_depIdxs = []int32{
	0, // 0: collect.AuthorResponse.data:type_name -> collect.Author
	1, // 1: collect.HotAuthorsResponse.data:type_name -> collect.SimpleAuthor
	7, // 2: collect.AuthorPaginationResponse.data:type_name -> collect.AuthorPaginationResponse.Authors
	0, // 3: collect.AuthorPaginationResponse.Authors.list:type_name -> collect.Author
...
func file_collect_author_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_collect_author_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AuthorPaginationResponse_Authors); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
