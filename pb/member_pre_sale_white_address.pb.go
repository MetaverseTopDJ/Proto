...
func (x *MemberPreSaleWhiteAddress) GetCreatedAt() string {
	if x != nil {
		return x.CreatedAt
	}
	return ""
...
func (x *MemberPreSaleWhiteAddress) GetUpdatedAt() string {
	if x != nil {
		return x.UpdatedAt
	}
	return ""
...
var file_member_member_pre_sale_white_address_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x04, 0x52, 0x06, 0x63, 0x61, 0x72, 0x64, 0x49, 0x64, 0x12, 0x18, 0x0a, 0x07, 0x61,
