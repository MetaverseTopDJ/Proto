...
var file_nft_nft_proto_rawDesc = []byte{
	...
	0x6c, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x32, 0xcf,
	0x27, 0x0a, 0x0a, 0x4e, 0x46, 0x54, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x31, 0x0a,
...
var file_nft_nft_proto_goTypes = []interface{}{
	...
	(*BlindBoxWhiteAddressPaginationResponse)(nil), // 69: nft.BlindBoxWhiteAddressPaginationResponse
	(*CollectResponse)(nil),                        // 70: nft.CollectResponse
	(*CollectDetailResponse)(nil),                  // 71: nft.CollectDetailResponse
	(*CollectPaginationResponse)(nil),              // 72: nft.CollectPaginationResponse
	(*SimpleCollectPaginationResponse)(nil),        // 73: nft.SimpleCollectPaginationResponse
	(*BlindBoxExchangeResponse)(nil),               // 74: nft.BlindBoxExchangeResponse
	(*CountBlindBoxExchangeResponse)(nil),          // 75: nft.CountBlindBoxExchangeResponse
	(*CollectExchangeResponse)(nil),                // 76: nft.CollectExchangeResponse
	(*CheckResponse)(nil),                          // 77: global.CheckResponse
	(*ContractResponse)(nil),                       // 78: global.ContractResponse
	(*ContractsResponse)(nil),                      // 79: global.ContractsResponse
	(*ContractAddressResponse)(nil),                // 80: global.ContractAddressResponse
	(*ContractPaginationResponse)(nil),             // 81: global.ContractPaginationResponse
	(*MemberNftPaginationResponse)(nil),            // 82: nft.MemberNftPaginationResponse
	(*NftMemberPaginationResponse)(nil),            // 83: nft.NftMemberPaginationResponse
}
var file_nft_nft_proto_depIdxs = []int32{
	...
	35, // 44: nft.NFTService.CreateBlindBoxStage:input_type -> nft.ModifyBlindBoxStagePost
	35, // 45: nft.NFTService.UpdateBlindBoxStage:input_type -> nft.ModifyBlindBoxStagePost
	34, // 46: nft.NFTService.RemoveBlindBoxStage:input_type -> nft.BlindBoxStagePost
	36, // 47: nft.NFTService.BlindBoxWhiteAddressPagination:input_type -> nft.BlindBoxWhiteAddressPaginationPost
	37, // 48: nft.NFTService.CreateBlindBoxWhiteAddress:input_type -> nft.CreateBlindBoxWhiteAddressPost
	38, // 49: nft.NFTService.RemoveBlindBoxWhiteAddress:input_type -> nft.RemoveBlindBoxWhiteAddressPost
	16, // 50: nft.NFTService.Collect:input_type -> global.InfoPost
	16, // 51: nft.NFTService.CollectDetail:input_type -> global.InfoPost
	18, // 52: nft.NFTService.CollectPagination:input_type -> global.PaginationPost
	18, // 53: nft.NFTService.SimpleCollectPagination:input_type -> global.PaginationPost
	39, // 54: nft.NFTService.CreateCollect:input_type -> nft.CreateCollectPost
	40, // 55: nft.NFTService.UpdateCollect:input_type -> nft.UpdateCollectPost
	41, // 56: nft.NFTService.ModifyCollect:input_type -> nft.ModifyCollectPost
	21, // 57: nft.NFTService.ChangeCollectStatus:input_type -> global.ChangeStatusPost
	16, // 58: nft.NFTService.BlindBoxExchange:input_type -> global.InfoPost
	17, // 59: nft.NFTService.MemberBlindBoxExchange:input_type -> global.EmptyPost
	42, // 60: nft.NFTService.AddressBlindBoxExchange:input_type -> nft.AddressBlindBoxExchangePost
	16, // 61: nft.NFTService.GenCollectSnapshot:input_type -> global.InfoPost
	16, // 62: nft.NFTService.CollectExchange:input_type -> global.InfoPost
	6,  // 63: nft.NFTService.CheckCollectExchangeTx:input_type -> nft.CheckCollectExchangePost
	7,  // 64: nft.NFTService.CheckBlindBoxExchangeTx:input_type -> nft.CheckBlindExchangePost
	16, // 65: nft.NFTService.NftContract:input_type -> global.InfoPost
	17, // 66: nft.NFTService.NftContracts:input_type -> global.EmptyPost
	17, // 67: nft.NFTService.NftContractAddress:input_type -> global.EmptyPost
	18, // 68: nft.NFTService.NftContractPagination:input_type -> global.PaginationPost
	43, // 69: nft.NFTService.CreateNftContract:input_type -> global.CreateContractPost
	44, // 70: nft.NFTService.UpdateNftContract:input_type -> global.UpdateContractPost
	21, // 71: nft.NFTService.ChangeNftContractStatus:input_type -> global.ChangeStatusPost
	45, // 72: nft.NFTService.CheckBlindBoxTx:input_type -> nft.CheckBlindBoxTxPost
	46, // 73: nft.NFTService.MemberNftPagination:input_type -> nft.MemberNftPaginationPost
	47, // 74: nft.NFTService.NftMemberPagination:input_type -> nft.NftMemberPaginationPost
	16, // 75: nft.NFTService.Nft:input_type -> global.InfoPost
	3,  // 76: nft.NFTService.NftPagination:input_type -> nft.NftPaginationPost
	4,  // 77: nft.NFTService.NftCreatorPagination:input_type -> nft.NftCreatorPaginationPost
	5,  // 78: nft.NFTService.NftTransferPagination:input_type -> nft.NftTransferPaginationPost
	48, // 79: nft.NFTService.Author:output_type -> nft.AuthorResponse
	49, // 80: nft.NFTService.AuthorDetail:output_type -> nft.SimpleAuthorResponse
	50, // 81: nft.NFTService.HotAuthors:output_type -> nft.HotAuthorsResponse
	50, // 82: nft.NFTService.CacheAllAuthors:output_type -> nft.HotAuthorsResponse
	51, // 83: nft.NFTService.AuthorPagination:output_type -> nft.AuthorPaginationResponse
	48, // 84: nft.NFTService.CreateAuthor:output_type -> nft.AuthorResponse
	48, // 85: nft.NFTService.UpdateAuthor:output_type -> nft.AuthorResponse
	48, // 86: nft.NFTService.ChangeAuthorStatus:output_type -> nft.AuthorResponse
	52, // 87: nft.NFTService.Work:output_type -> nft.WorkResponse
	53, // 88: nft.NFTService.Works:output_type -> nft.WorksResponse
	54, // 89: nft.NFTService.WorkDetail:output_type -> nft.WorkDetailResponse
	55, // 90: nft.NFTService.RecommendWorks:output_type -> nft.RecommendWorksResponse
	56, // 91: nft.NFTService.AuthorWorkPagination:output_type -> nft.AuthorWorkPaginationResponse
	57, // 92: nft.NFTService.WorkPagination:output_type -> nft.WorkPaginationResponse
	52, // 93: nft.NFTService.CreateWork:output_type -> nft.WorkResponse
	52, // 94: nft.NFTService.UpdateWork:output_type -> nft.WorkResponse
	52, // 95: nft.NFTService.ChangeWorkStatus:output_type -> nft.WorkResponse
	58, // 96: nft.NFTService.BlindBox:output_type -> nft.BlindBoxResponse
	59, // 97: nft.NFTService.BlindBoxes:output_type -> nft.BlindBoxesResponse
	60, // 98: nft.NFTService.BlindBoxCount:output_type -> nft.BlindBoxCountResponse
	61, // 99: nft.NFTService.BlindBoxTop:output_type -> nft.BlindBoxTopResponse
	60, // 100: nft.NFTService.BlindBoxTopCount:output_type -> nft.BlindBoxCountResponse
	62, // 101: nft.NFTService.BlindBoxDetail:output_type -> nft.BlindBoxDetailResponse
	63, // 102: nft.NFTService.BlindBoxPagination:output_type -> nft.BlindBoxPaginationResponse
	58, // 103: nft.NFTService.CreateBlindBox:output_type -> nft.BlindBoxResponse
	58, // 104: nft.NFTService.UpdateBlindBox:output_type -> nft.BlindBoxResponse
	58, // 105: nft.NFTService.StartBlindBox:output_type -> nft.BlindBoxResponse
	64, // 106: nft.NFTService.BlindBoxContent:output_type -> nft.BlindBoxContentResponse
	65, // 107: nft.NFTService.BlindBoxContentPagination:output_type -> nft.BlindBoxContentPaginationResponse
	66, // 108: nft.NFTService.CreateBlindBoxContent:output_type -> global.ResultResponse
	66, // 109: nft.NFTService.UpdateBlindBoxContent:output_type -> global.ResultResponse
	66, // 110: nft.NFTService.RemoveBlindBoxContent:output_type -> global.ResultResponse
	67, // 111: nft.NFTService.BlindBoxStage:output_type -> nft.BlindBoxStageResponse
	68, // 112: nft.NFTService.BlindBoxStages:output_type -> nft.BlindBoxStagesResponse
	67, // 113: nft.NFTService.CreateBlindBoxStage:output_type -> nft.BlindBoxStageResponse
	67, // 114: nft.NFTService.UpdateBlindBoxStage:output_type -> nft.BlindBoxStageResponse
	66, // 115: nft.NFTService.RemoveBlindBoxStage:output_type -> global.ResultResponse
	69, // 116: nft.NFTService.BlindBoxWhiteAddressPagination:output_type -> nft.BlindBoxWhiteAddressPaginationResponse
	66, // 117: nft.NFTService.CreateBlindBoxWhiteAddress:output_type -> global.ResultResponse
	66, // 118: nft.NFTService.RemoveBlindBoxWhiteAddress:output_type -> global.ResultResponse
	70, // 119: nft.NFTService.Collect:output_type -> nft.CollectResponse
	71, // 120: nft.NFTService.CollectDetail:output_type -> nft.CollectDetailResponse
	72, // 121: nft.NFTService.CollectPagination:output_type -> nft.CollectPaginationResponse
	73, // 122: nft.NFTService.SimpleCollectPagination:output_type -> nft.SimpleCollectPaginationResponse
	70, // 123: nft.NFTService.CreateCollect:output_type -> nft.CollectResponse
	70, // 124: nft.NFTService.UpdateCollect:output_type -> nft.CollectResponse
	66, // 125: nft.NFTService.ModifyCollect:output_type -> global.ResultResponse
	70, // 126: nft.NFTService.ChangeCollectStatus:output_type -> nft.CollectResponse
	74, // 127: nft.NFTService.BlindBoxExchange:output_type -> nft.BlindBoxExchangeResponse
	75, // 128: nft.NFTService.MemberBlindBoxExchange:output_type -> nft.CountBlindBoxExchangeResponse
	75, // 129: nft.NFTService.AddressBlindBoxExchange:output_type -> nft.CountBlindBoxExchangeResponse
	66, // 130: nft.NFTService.GenCollectSnapshot:output_type -> global.ResultResponse
	76, // 131: nft.NFTService.CollectExchange:output_type -> nft.CollectExchangeResponse
	77, // 132: nft.NFTService.CheckCollectExchangeTx:output_type -> global.CheckResponse
	77, // 133: nft.NFTService.CheckBlindBoxExchangeTx:output_type -> global.CheckResponse
	78, // 134: nft.NFTService.NftContract:output_type -> global.ContractResponse
	79, // 135: nft.NFTService.NftContracts:output_type -> global.ContractsResponse
	80, // 136: nft.NFTService.NftContractAddress:output_type -> global.ContractAddressResponse
	81, // 137: nft.NFTService.NftContractPagination:output_type -> global.ContractPaginationResponse
	78, // 138: nft.NFTService.CreateNftContract:output_type -> global.ContractResponse
	78, // 139: nft.NFTService.UpdateNftContract:output_type -> global.ContractResponse
	78, // 140: nft.NFTService.ChangeNftContractStatus:output_type -> global.ContractResponse
	77, // 141: nft.NFTService.CheckBlindBoxTx:output_type -> global.CheckResponse
	82, // 142: nft.NFTService.MemberNftPagination:output_type -> nft.MemberNftPaginationResponse
	83, // 143: nft.NFTService.NftMemberPagination:output_type -> nft.NftMemberPaginationResponse
	8,  // 144: nft.NFTService.Nft:output_type -> nft.NFTResponse
	9,  // 145: nft.NFTService.NftPagination:output_type -> nft.NFTPaginationResponse
	10, // 146: nft.NFTService.NftCreatorPagination:output_type -> nft.NFTCreatorPaginationResponse
	11, // 147: nft.NFTService.NftTransferPagination:output_type -> nft.NFTTransferPaginationResponse
	79, // [79:148] is the sub-list for method output_type
	10, // [10:79] is the sub-list for method input_type
